...
#
####################
alias sshsergio1='until ssh -qo ConnectTimeout=1 amigo@sergio1; do echo waiting for sergio1 to come online...; sleep 2; done'
alias sshsergio2='until ssh -qo ConnectTimeout=1 amigo@sergio2; do echo waiting for sergio2 to come online...; sleep 2; done'
...
alias sergio-dashboard='tue-dashboard sergio1 & sleep 1; disown; wmctrl -r ws://sergio1:9090 -b add,sticky'
...
alias say='rostopic pub --once /sergio/text_to_speech/input std_msgs/String'
function praat() {
...
alias sergio-copy-my-id="ssh-copy-id amigo@sergio1; ssh-copy-id amigo@sergio2"
