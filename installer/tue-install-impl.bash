...
tue-install-system-now git gcc python-pip python-dev python3-pip python3-dev

tue-install-pip2-now docutils setuptools
tue-install-pip3-now docutils setuptools
