...
#### Ubuntu 16.04
```bash
wget -O - https://raw.githubusercontent.com/tue-robotics/tue-env/ar13pit-patch/fix-names-scripts-targets/installer/scripts/bootstrap.bash | bash -s kinetic && source ~/.bashrc
