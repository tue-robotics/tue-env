...
tue-install-system-now git python-pip python-dev python-pkg-resources python-setuptools python3-pip python3-dev python3-pkg-resources python3-setuptools
